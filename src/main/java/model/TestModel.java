...
public class TestModel {
	...
	public static void main(String[] args) {
		...
		System.out.println("Info Prof Aggiornate: " + prof1.toString());
		prof1.RemoveMateria("Fisica Generale");
		System.out.println("Info Prof dopo rimozione: " + prof1.toString());
		...
		System.out.println("Info Prof Finali: " + prof1.toString());
	}
